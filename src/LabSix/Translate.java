...
public class Translate {
	...
	// private static BufferedReader buf =new BufferedReader(new
	...
	public static void main(String[] args) {
		...
		while (choice.equalsIgnoreCase("y")) {
			// prompt the user for a word or sentence declare and initialize
			// instance variables.
			...
			for (int i = 0; i < 1; i++) {
				...
				// if statement for if a word starts with a vowel, just add way
				// onto the ending
